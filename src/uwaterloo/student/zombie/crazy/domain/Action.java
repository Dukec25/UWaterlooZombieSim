...
public class Action
{
    public enum ActionType
    {
        ...
        IDLE, ENCOUNTERED, FIGHTING, RUNNING
    }

    final ActionType type;
    final long totalDurationInSecs; // how much time is required to complete the
                                    // action from start to finish
    long remainingDurationInSecs; // how much more time is needed to complete
                                  // the action

    // extra data (usually that go with specific action types) that doesn't
    // necessarily need to be populated
    Structure dest = null;
